               ...
               <div className="flex flex-col md:flex-row gap-8 justify-between">
                  ...
                  <div className="my-4">
                     ...
                     <div className="flex mt-3 gap-4 text-3xl">
                        <Link className="hover:text-orange-200" target="_blank" href="https://wa.me/+59897111899">
                           <FaWhatsapp />
                        </Link>
                        <Link
                        ...
                        <Link className="hover:text-orange-200" target="_blank" href="https://www.facebook.com/">
                           <FaFacebookF />
                        </Link>
                     </div>
                  </div>
                  <div className="my-4 max-w-[18rem]">
                     ...
                     <p className="text-lg">Av. 18 de julio y Carlos Quijano 6012 11100 Montevideo, Uruguay.</p>
                     <p className="text-lg mt-4">Tel: +598-111-899</p>
                     <p className="text-lg">info@taller.com.uy</p>
