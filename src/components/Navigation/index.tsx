...
export default function Navigation() {
   return (
      <div className="flex items-center justify-between gap-4 max-w-[85rem] mx-auto text-black px-4 sm:px-12 py-5">
         <Logo />
         <Menu />
         <Link
...
function Logo() {
   return (
      <div>
         ...
         <Link href="https://wa.me/+59897111899" target="_blank" className="text-lg font-bold md:hidden">
            +598-097-111-899
         </Link>
      </div>
   );
